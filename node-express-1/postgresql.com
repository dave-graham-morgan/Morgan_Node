...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2024-01-09T20:35:36.453935" />
  ...
  <link href="/media/css/fontawesome.css?12767596" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
  <link rel="stylesheet" type="text/css" href="/dyncss/base.css?12767596">

  <script src="/media/js/theme.js?12767596"></script>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/influxdb-fdw-210-release-2783/">InfluxDB FDW 2.1.0 release</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-01-09 by Toshiba</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/benetl-a-free-etl-tool-for-postgresql-out-in-version-58-2779/">Benetl, a free ETL tool for PostgreSQL, out in version 5.8</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-01-09 by Benetl</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgconf-india-2024-talks-live-and-ticket-sale-started-2781/">PGConf India 2024: Talks live and ticket sale started</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-01-09 by PGConf India</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/fosdem-pgday-2024-schedule-posted-and-registration-open-2782/">FOSDEM PGDay 2024 - Schedule Posted and Registration Open!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-01-08 by PostgreSQL Europe</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_dbms_metadata-v100-released-2778/">pg_dbms_metadata v1.0.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-01-05 by HexaCluster</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hl"> Create an AI Expert With Open Source Tools and pgvector</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Sergey Pronin</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-01-09</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hi"> Incremental Backups: Evergreen and Other Use Cases</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hj"> Elixir clustering using Postgres</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Filipe Cabaco</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-01-09</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hk"> PGConf.dev: Why, what, and how you can participate</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hh"> Waiting for PostgreSQL 17 – Add support for incremental backup.</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hubert &#x27;depesz&#x27; Lubaczewski</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-01-08</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hf"> Copy-and-Paste A New Postgres Dev Env In 5 Min</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hg"> An Overview of Distributed  PostgreSQL Architectures</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6he"> PgConf.Dev @ Vancouver, May 28-31</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Paul Ramsey</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-01-07</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6hd"> How to setup TLS connection for PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;David Z</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-01-06</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?12767596"></script>
